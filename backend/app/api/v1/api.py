...
from app.api.v1.endpoints import auth, materials, quotes, orders, production, customers, payments, reports, dashboard, pdf_print
...
api_router.include_router(pdf_print.router, prefix="/print", tags=["PDF打印"])
